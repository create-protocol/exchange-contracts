...
import {IMercadoExchange} from "./interfaces/IMercadoExchange.sol";
...
/**
 * @title MercadoExchange
 * @notice It is the core contract of the Mercado exchange.
 */
contract MercadoExchange is IMercadoExchange, ReentrancyGuard, Ownable {
